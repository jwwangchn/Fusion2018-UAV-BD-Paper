...
\title{Bottle Detection from Low-Altitude UAV Imagery with the Oriented Bounding Box
%\thanks{Identify applicable funding agency here. If none, delete this.}
}
\author{\IEEEauthorblockN{Jinwang Wang, Name2, Name3}
	\IEEEauthorblockA{\textit{School of Electronic Information, Wuhan University} Wuhan, China \\
		jwwangchn@whu.edu.cn, email2, email3}
